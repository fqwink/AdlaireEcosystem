...
final class DeploymentEvidence
{
    public static function artifacts(): array
    {
        return [
            ...
            'provider_runtime_operation_journal',
            'provider_runtime_preflight',
            'provider_runtime_apply_plan',
            'provider_runtime_rollback_drill',
            'provider_runtime_audit_bundle',
            'provider_runtime_operations_gate',
            'server_api_driver_contract',
            'server_api_capability_probe',
            'server_api_auth_session',
            'remote_command_sandbox',
            'server_api_transaction_engine',
            'provider_drift_detection',
            'server_api_execution_gate',
            'server_api_operation_catalog',
            'provider_execution_policy',
            'remote_file_sync_plan',
            'server_state_reconciliation',
            'safe_restart_orchestrator',
            'snapshot_backup_control',
            'server_automation_release_gate',
            'server_automation_execution',
        ];
    }
}
