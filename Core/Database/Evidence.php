...
public static function eventHealthSummary(): array
    {
        return AdlaireEventLog::healthSummary(self::$events);
    }

public static function eventRecoveryEvidence(?string $collection = null): array
    {
        if ($collection !== null) {
            self::assertCollection($collection);
            return AdlaireEventLog::recoveryEvidence(self::$events, self::snapshot($collection), self::rebuildSnapshot($collection));
        }

        return AdlaireEventLog::recoveryEvidence(self::$events);
    }

public static function eventOperationalGuard(): array
    {
        return AdlaireEventLog::operationalGuard(self::$events);
    }

public static function eventTrustScore(): array
    {
        return AdlaireEventLog::trustScore(self::$events);
    }

public static function eventRestoreReadiness(): array
    {
        return AdlaireEventLog::restoreReadiness(self::$events);
    }

public static function eventAuditPacket(): array
    {
        return AdlaireEventLog::auditPacket(self::$events);
    }

public static function eventIncidentPacket(): array
    {
        return AdlaireEventLog::incidentPacket(self::$events);
    }

public static function eventDegradationReport(): array
    {
        return AdlaireEventLog::degradationReport(self::$events);
    }

public static function eventWriteSafetyGate(string $type, string $domain = 'realtime_database'): array
    {
        return AdlaireEventLog::writeSafetyGate(self::$events, $type, $domain);
    }

public static function eventReplayWindow(int $fromSequence, int $toSequence): array
    {
        return AdlaireEventLog::replayWindow(self::$events, $fromSequence, $toSequence);
    }

public static function eventCursorDriftReport(?string $cursor): array
    {
        return AdlaireEventLog::cursorDriftReport(self::$events, $cursor);
    }

public static function eventExportIntegrity(?array $packet = null): array
    {
        return AdlaireEventLog::exportIntegrity($packet ?? self::eventExportPacket());
    }

public static function eventRestoreImpact(array $candidateEvents): array
    {
        return AdlaireEventLog::restoreImpact($candidateEvents, self::$events);
    }

public static function eventRetentionDecisionView(): array
    {
        return AdlaireEventLog::retentionDecisionView(self::$events);
    }

public static function eventOperationalSlo(): array
    {
        return AdlaireEventLog::operationalSlo(self::$events);
    }

public static function eventHandoffSummary(): array
    {
        return AdlaireEventLog::handoffSummary(self::$events);
    }

public static function eventPreflightReport(string $type, string $domain = 'realtime_database', array $payload = []): array
    {
        return AdlaireEventLog::preflightReport(self::$events, $type, $domain, $payload);
    }

public static function eventChainSnapshot(): array
    {
        return AdlaireEventLog::chainSnapshot(self::$events);
    }

public static function eventContinuityProof(): array
    {
        return AdlaireEventLog::continuityProof(self::$events);
    }

public static function eventPayloadIntegrityReport(): array
    {
        return AdlaireEventLog::payloadIntegrityReport(self::$events);
    }

public static function eventDomainIsolationReport(): array
    {
        return AdlaireEventLog::domainIsolationReport(self::$events);
    }

public static function eventRecoveryRoute(): array
    {
        return AdlaireEventLog::recoveryRoute(self::$events);
    }

public static function eventManualReviewQueue(): array
    {
        return AdlaireEventLog::manualReviewQueue(self::$events);
    }

public static function eventOperationalTimeline(): array
    {
        return AdlaireEventLog::operationalTimeline(self::$events);
    }

public static function eventEvidenceSeal(): array
    {
        return AdlaireEventLog::evidenceSeal(self::$events);
    }

public static function eventTrustLedger(): array
    {
        return AdlaireEventLog::trustLedger(self::$events);
    }
